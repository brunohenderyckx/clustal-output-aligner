...
def align_data(alignment_input, alignment_number):
    """
    ...
    filename = r"Alignment Output.xlsx"
    workbook = Workbook()
...
def execute():
    ...
    alignment_file = align_data(alignment_input, alignment_number) #pass arguments here --> replace notepad opening
    return Response(
